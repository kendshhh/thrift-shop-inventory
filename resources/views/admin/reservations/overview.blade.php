                                    ...
                                    @if ($reservationRow)
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end mt-2 border-0 shadow-lg glass-dropdown-menu">
                                                <li>
                                                    <form method="POST" action="{{ route('admin.reservations.remove-item', [$reservationRow['reservation_id'], $reservationRow['reservation_item_id']]) }}" data-confirm-action data-confirm-message='Release this reserved item?' data-confirm-variant='danger' data-confirm-label='Remove'>
                                                        @csrf
                                                        @method('PATCH')
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('admin.reservations.extend', $reservationRow['reservation_id']) }}" data-confirm-action data-confirm-message='Extend this reservation timer?' data-confirm-variant='primary' data-confirm-label='Confirm'>
                                                        @csrf
                                                        @method('PATCH')
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('admin.reservations.mark-sold', $reservationRow['reservation_id']) }}" data-confirm-action data-confirm-message='Mark this reservation as sold?' data-confirm-variant='danger' data-confirm-label='Confirm'>
                                                        @csrf
                                                        @method('PATCH')
            ...
            @forelse ($userReservationGroups as $group)
                <div class="overview-user-group mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end mt-2 border-0 shadow-lg glass-dropdown-menu">
                                                    <li>
                                                    <form method="POST" action="{{ route('admin.reservations.remove-item', [$row['reservation']->id, $row['reservation_item']->id]) }}" data-confirm-action data-confirm-message='Remove this item from the reservation?' data-confirm-variant='danger' data-confirm-label='Remove'>
                                                            @csrf
                                                            @method('PATCH')
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                        ...
                        @if ($group['user'])
                            <form method="POST" action="{{ route('admin.reservations.cancel-all-for-user', $group['user']) }}" data-confirm-action data-confirm-message='Cancel all active reservations for this user?' data-confirm-variant='danger' data-confirm-label='Confirm'>
                                @csrf
                                @method('PATCH')
